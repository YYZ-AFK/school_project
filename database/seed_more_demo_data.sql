...
SET @has_sale_address := (SELECT COUNT(*)
...
DELETE
FROM drug_sale
WHERE drug_id = 12650475;
DELETE
FROM drug
WHERE drug_id = 12650475
   OR drug_name REGEXP '^[0-9]+$'
   OR drug_name LIKE '%测试%';
DELETE
FROM drugcompany
WHERE company_name REGEXP '^[0-9]+$'
   OR company_phone REGEXP '^6+$';
DELETE
FROM city
WHERE city_number IN (100, 0);
...
INSERT INTO doctor (id, name, age, sex, level_id, phone, type_id, hospital, createtime, updatetime, account_id)
VALUES (900101, '刘海宁', 45, 1, 1, '13966010001', 1, '青岛第一人民医院', NOW(), NOW(), NULL),
...
UPDATE sale
SET sale_name='同仁堂青岛中心药房',
    sale_phone='13245789012',
    updatetime=NOW()
WHERE sale_id = 12635272;
UPDATE sale
SET sale_name='益丰大药房市南店',
    sale_phone='15622334455',
    updatetime=NOW()
WHERE sale_id = 12635280;
UPDATE sale
SET sale_name='国大药房李沧店',
    sale_phone='13354449777',
    updatetime=NOW()
WHERE sale_id = 12635282;
UPDATE sale
SET sale_name='一心堂大药房',
    sale_phone='15566778899',
    updatetime=NOW()
WHERE sale_id = 12635285;
UPDATE sale
SET sale_name='健之佳药房',
    sale_phone='18877889901',
    updatetime=NOW()
WHERE sale_id = 12635286;
UPDATE sale
SET sale_name='华氏大药房',
    sale_phone='17766554433',
    updatetime=NOW()
WHERE sale_id = 12635287;
UPDATE sale
SET sale_name='德生堂药房',
    sale_phone='16655223344',
    updatetime=NOW()
WHERE sale_id = 12635288;
UPDATE sale
SET sale_name='康佰馨大药房',
    sale_phone='18966557788',
    updatetime=NOW()
WHERE sale_id = 12635289;
UPDATE sale
SET sale_name='成大方圆药房',
    sale_phone='15811223344',
    updatetime=NOW()
WHERE sale_id = 12635290;
UPDATE sale
SET sale_name='开心人大药房',
    sale_phone='15122334455',
    updatetime=NOW()
WHERE sale_id = 12635291;
UPDATE sale
SET sale_name='百草堂药房',
    sale_phone='15733445566',
    updatetime=NOW()
WHERE sale_id = 12635292;

INSERT INTO sale (sale_id, sale_name, sale_phone, createtime, updatetime)
VALUES (12635293, '九州通大药房', '13670010001', NOW(), NOW()),
...
ON DUPLICATE KEY UPDATE sale_name=VALUES(sale_name),
                        sale_phone=VALUES(sale_phone),
                        updatetime=NOW();

UPDATE sale
SET address='山东省青岛市市南区香港中路18号',
    lng=120.38264,
    lat=36.06708
WHERE sale_id = 12635265;
UPDATE sale
SET address='山东省青岛市市北区台东三路58号',
    lng=120.35620,
    lat=36.08760
WHERE sale_id = 12635266;
UPDATE sale
SET address='山东省青岛市李沧区九水东路130号',
    lng=120.43100,
    lat=36.16080
WHERE sale_id = 12635267;
UPDATE sale
SET address='山东省青岛市崂山区海尔路182号',
    lng=120.46750,
    lat=36.10650
WHERE sale_id = 12635268;
UPDATE sale
SET address='山东省青岛市黄岛区长江中路266号',
    lng=120.19780,
    lat=35.96040
WHERE sale_id = 12635269;
UPDATE sale
SET address='山东省青岛市城阳区正阳中路205号',
    lng=120.39630,
    lat=36.30710
WHERE sale_id = 12635270;
UPDATE sale
SET address='山东省青岛市即墨区鹤山路599号',
    lng=120.44700,
    lat=36.38900
WHERE sale_id = 12635271;
UPDATE sale
SET address='山东省青岛市市南区山东路10号',
    lng=120.38480,
    lat=36.07160
WHERE sale_id = 12635272;
UPDATE sale
SET address='山东省青岛市市南区南京路8号',
    lng=120.39420,
    lat=36.07070
WHERE sale_id = 12635280;
UPDATE sale
SET address='山东省青岛市李沧区书院路37号',
    lng=120.42140,
    lat=36.15870
WHERE sale_id = 12635282;
UPDATE sale
SET address='山东省青岛市胶州市广州南路167号',
    lng=120.03310,
    lat=36.26470
WHERE sale_id = 12635285;
UPDATE sale
SET address='山东省青岛市平度市人民路88号',
    lng=119.95900,
    lat=36.78820
WHERE sale_id = 12635286;
UPDATE sale
SET address='山东省青岛市莱西市烟台路52号',
    lng=120.51760,
    lat=36.88910
WHERE sale_id = 12635287;
UPDATE sale
SET address='山东省青岛市西海岸新区井冈山路157号',
    lng=120.19020,
    lat=35.96310
WHERE sale_id = 12635288;
UPDATE sale
SET address='山东省青岛市崂山区香港东路195号',
    lng=120.47850,
    lat=36.09370
WHERE sale_id = 12635289;
UPDATE sale
SET address='山东省青岛市市北区辽阳西路100号',
    lng=120.38140,
    lat=36.10350
WHERE sale_id = 12635290;
UPDATE sale
SET address='山东省青岛市城阳区春阳路211号',
    lng=120.40320,
    lat=36.31980
WHERE sale_id = 12635291;
UPDATE sale
SET address='山东省青岛市即墨区蓝鳌路788号',
    lng=120.45280,
    lat=36.39140
WHERE sale_id = 12635292;
UPDATE sale
SET address='山东省青岛市崂山区深圳路222号',
    lng=120.46880,
    lat=36.11140
WHERE sale_id = 12635293;
UPDATE sale
SET address='山东省青岛市市北区人民路4号',
    lng=120.36670,
    lat=36.09650
WHERE sale_id = 12635294;
UPDATE sale
SET address='山东省青岛市市南区太平路51号',
    lng=120.31940,
    lat=36.06430
WHERE sale_id = 12635295;
UPDATE sale
SET address='山东省青岛市黄岛区香江路68号',
    lng=120.19080,
    lat=35.96390
WHERE sale_id = 12635296;
UPDATE sale
SET address='山东省青岛市城阳区长城路89号',
    lng=120.38950,
    lat=36.30620
WHERE sale_id = 12635297;
UPDATE sale
SET address='山东省青岛市李沧区夏庄路1号',
    lng=120.42900,
    lat=36.16440
WHERE sale_id = 12635298;
UPDATE sale
SET address='山东省青岛市胶州市兰州东路210号',
    lng=120.04280,
    lat=36.27060
WHERE sale_id = 12635299;

-- 5. Add more drug companies.
INSERT INTO drugcompany (company_id, company_name, company_phone, createtime, updatetime)
VALUES (11265482, '北京同仁堂科技发展股份有限公司', '01087654321', NOW(), NOW()),
...
INSERT INTO city (city_id, city_number, createtime, updatetime)
VALUES (12630293, 110100, NOW(), NOW()),
...
ON DUPLICATE KEY UPDATE city_number=VALUES(city_number),
                        updatetime=NOW();

-- 7. Add policy data.
INSERT INTO medical_policy (id, title, message, city_id, create_time, update_time)
VALUES (1035, '门诊慢特病跨省直接结算流程', '参保人员完成备案后，可在定点医疗机构按规定办理门诊慢特病费用直接结算。',
        12630293, DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s'), DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s')),
       (1036, '医保电子凭证使用指引', '参保人员可使用医保电子凭证完成挂号、缴费、购药结算等业务。', 12630295,
        DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s'), DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s')),
       (1037, '异地就医备案管理办法', '长期异地居住人员和临时外出就医人员可通过线上渠道办理备案。', 12630296,
        DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s'), DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s')),
       (1038, '住院费用医保报销材料说明', '住院报销需提供费用清单、发票、出院记录和身份证明等材料。', 12630298,
        DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s'), DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s')),
       (1039, '定点零售药店购药结算规范', '参保人在定点药店购药时，应核验处方和医保电子凭证。', 12630299,
        DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s'), DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s')),
       (1040, '门诊统筹支付政策', '符合条件的门诊费用按当地门诊统筹政策进行支付。', 12630300,
        DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s'), DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s')),
       (1041, '居民医保参保缴费提醒', '居民医保集中缴费期内完成缴费，次年按规定享受医保待遇。', 12630301,
        DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s'), DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s')),
       (1042, '医保目录药品管理说明', '医保目录内药品按照甲类、乙类及地方政策执行报销。', 12630302,
        DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s'), DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s'))
...
INSERT INTO company_policy (id, title, message, company_id, create_time, update_time)
VALUES (124591, '药品生产质量追溯要求', '药品生产企业应建立批号追溯、出入库记录和质量审核制度。', 11265465, NOW(), NOW()),
...
-- 8. Add material data.
INSERT INTO material (id, title, message, create_time, update_time)
VALUES (12, '异地就医备案材料', '身份证、医保电子凭证、异地长期居住证明或转诊备案材料。', NOW(), NOW()),
...
WHERE drug_id IN (12650466, 12650467, 12650468, 12650469, 12650470, 12650471)
  AND sale_id IN
      (12635270, 12635271, 12635272, 12635280, 12635282, 12635293, 12635294, 12635295, 12635296, 12635297, 12635298,
       12635299);

INSERT INTO drug_sale (drug_id, sale_id)
VALUES (12650466, 12635293),
       (12650466, 12635294),
       (12650467, 12635295),
       (12650467, 12635296),
       (12650468, 12635297),
